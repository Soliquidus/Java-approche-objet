...
public class TestPersonne {
    public static void main(String[] args) {
        ...
        Personne personne1 = new Personne("Patoulacci", "Robert");
        personne1.setAdressePostale(adressePostale1);
        Personne personne2 = new Personne("Connor", "Sarah");
        personne2.setAdressePostale(adressePostale2);
